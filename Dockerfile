...
WORKDIR /extracted
RUN jar -xf /root/app/target/blogentrymanager-0.0.1-SNAPSHOT.jar
...
################# ENTRYPOINT ####################
ENTRYPOINT ["java", "-Xms128m", "-Xmx128m", "-cp", "app:app/lib/*", "com.example.blogentrymanager.BlogentrymanagerApplication"]
